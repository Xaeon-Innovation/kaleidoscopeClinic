...
export default function AdminLeadsPage() {
  ...
  function exportCsv() {
    const header = "Name,Email,Phone,Message,Source,Date,Contacted";
              ...
              >
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {!lead.contacted && (
                      <span className="rounded-full bg-[var(--gold)] px-2 py-0.5 text-[10px] font-bold text-[var(--brand-dark)]">
                        NEW
                      </span>
                    )}
                  </div>
                ...
                <div className="text-right">
                  <p className="text-xs text-black/40">{formatDate(lead.createdAt)}</p>
                ...
                <div className="border-t border-black/5 px-5 pb-5 pt-4">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className="rounded-xl border border-black/10 bg-white px-4 py-2 text-sm font-medium text-[var(--brand-dark)] hover:bg-black/[0.03]"
                    >
                      {lead.contacted ? "Mark as new" : "Mark as contacted"}
                    </button>
                    <button

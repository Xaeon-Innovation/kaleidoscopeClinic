...
import { getWhatsAppHref } from "./siteLinks";
      ...
      {open ? (
        <div className="mb-3 w-[min(280px,calc(100vw-2rem))] overflow-hidden rounded-2xl bg-white shadow-[var(--shadow-soft)] ring-1 ring-black/10">
          ...
          <div className="px-4 py-4">
            <div className="rounded-2xl bg-black/[0.04] px-3 py-2 text-xs text-black/70">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-4 inline-flex h-10 w-full items-center justify-center rounded-full bg-[#25D366] text-sm font-semibold text-white hover:bg-[#1ebe5d]"
            >
              Open Chat
            </a>
          </div>
